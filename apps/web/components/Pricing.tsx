...
const Pricing = () => {
  const plans: Plan[] = [
    {
      ...
      maxMonthlyReview: 50,
      description: "Perfect for individuals getting started with AI code review.",
    },
    {
      ...
      description: "Best for small teams needing deeper AI context and automation.",
    },
    {
      ...
      description: "For organizations needing scalable and secure AI integrations.",
    },
  ];
  ...
  const getFeaturesForPlan = (plan: Plan) => {
    ...
    if (plan.pathConfigCustomization) features.push("Path Configuration Customization");
    if (plan.labelConfigCustomization) features.push("Label Configuration Customization");
    if (plan.embeddingRepoContext) features.push("Repository Context Embedding");
    if (plan.maxRepoIssueEmbedding > 0) features.push(`${plan.maxRepoIssueEmbedding} Issue Embeddings per Repository`);
