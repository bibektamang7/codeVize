        ...
        <Table>
          <TableHeader>
            <TableRow className="border-gray-700 hover:bg-gray-800">
              <TableHead className="text-gray-300 font-medium">PR Title</TableHead>
              <TableHead className="text-gray-300 font-medium">Repository</TableHead>
              <TableHead className="text-gray-300 font-medium">Status</TableHead>
              <TableHead className="text-gray-300 font-medium">Last Updated</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {pullRequests.map((pr, index) => (
              <TableRow key={index} className="border-gray-700 hover:bg-gray-750 !py-20">
                <TableCell className="text-white font-medium">{pr.title}</TableCell>
                <TableCell className="text-gray-400">{pr.repository}</TableCell>
                <TableCell>
                  <Badge
                ...
                <TableCell className="text-gray-400">{pr.lastUpdated}</TableCell>
              </TableRow>
            ))}
          </TableBody>
        </Table>
