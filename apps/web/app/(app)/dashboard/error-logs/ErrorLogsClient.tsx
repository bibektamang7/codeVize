      ...
      {repos.length === 0 ? (
        <Card>
          <CardContent className="py-10 sm:py-12 text-center">
            ...
            <h3 className="text-lg sm:text-xl font-semibold">No Error Logs Found</h3>
                  ...
                  <CardHeader className="pb-3">
                    <div className="flex justify-between items-start">
                      <CardTitle className="flex items-center gap-2 flex-1 min-w-0">
                        ...
                        <span className="truncate text-sm sm:text-base">{repo.repoName}</span>
                      </CardTitle>
                      <Badge
                        variant="destructive"
                    ...
                    <div className="text-sm text-muted-foreground mb-3 min-h-[40px]">
                      {lastError ? (
                        <div className="truncate">
                          ...
                          {lastError.message.substring(0, 60)}{lastError.message.length > 60 ? "..." : ""}
                        </div>
                      ) : (
