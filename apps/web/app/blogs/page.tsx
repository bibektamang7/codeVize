  ...
  const blogPosts = [
    {
      ...
      excerpt: "Exploring how artificial intelligence is transforming the code review process and improving software quality.",
      date: "May 15, 2024",
      author: "Alex Johnson",
      readTime: "5 min read",
      category: "AI",
    },
    {
      ...
      excerpt: "Learn how to streamline your development workflow with automated tools and smart integrations.",
      date: "April 28, 2024",
    ...
    },
    {
      ...
      excerpt: "Discover how ML algorithms can help categorize and prioritize issues in large-scale projects.",
      date: "April 10, 2024",
      author: "Michael Chen",
      readTime: "6 min read",
      category: "ML",
    },
    {
      ...
      excerpt: "Strategies for improving team productivity and collaboration in software development projects.",
      date: "March 22, 2024",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Insights, tutorials, and stories from the Codevize team and community.
          </p>
        </div>
          ...
          <div>
            ...
            <div className="bg-gradient-to-b from-[#ffffff05] to-black/50 rounded-xl border border-[#ffffff1a] p-6">
              ...
              <div className="flex flex-wrap gap-2">
                {['AI', 'Workflow', 'ML', 'Team', 'Productivity', 'Tools', 'Tutorials'].map((category, index) => (
                  <Button 
                    key={index} 
                    variant="outline" 
